            ...
            <div className='container max-w-lg mx-auto bg-white overflow-clip'>
                ...
                <div className='px-6 mt-4'>
                    ...
                    <div className='flex flex-row justify-between'>
                        ...
                        <div>
                            <Link>
                                <button className='bg-red text-white px-5 py-3 rounded-2xl font-bold shadow-lg hover:bg-red_hover transition'>
                                    Bantu Sekarang
                                </button>
                            </Link>
                        </div>
                    </div>
                    <div className='mt-2 shadow-lg bg-pink rounded-lg p-5'>
