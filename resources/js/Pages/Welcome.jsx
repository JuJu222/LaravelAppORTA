            ...
            <div className="relative w-full h-full pb-10">
                ...
                <nav className="f-f-l relative z-10">
                    <div className="relative z-10 mx-auto container hidden w-full px-4 xl:px-0 lg:flex justify-between items-center py-11">
                        ...
                        <div className="flex items-center text-white text-base font-medium">
                            ...
                            <Link href={route('login')} className="px-6 py-3 bg-indigo-400 hover:bg-indigo-500 text-white text-base font-medium rounded-lg flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">
                                Sign In
                ...
                <div className="relative px-4 xl:px-0 container mx-auto md:flex items-center justify-center gap-8">
                    <div className="text-color w-full md:w-1/3 pt-16 lg:pt-32 xl:pt-12">
                        <h1 className="text-4xl md:text-4xl lg:text-6xl w-11/12 lg:w-11/12 xl:w-full xl:text-6xl text-gray-900 font-extrabold f-f-l">Yuk, mulailah segala sesuatu dengan cinta</h1>
                    ...
                    <img className="w-full mt-8 md:mt-0 object-fill md:w-1/3 md:-ml-4 lg:-ml-4 xl:ml-0" src="/img/landing.png" alt="sample page" role="img" />
