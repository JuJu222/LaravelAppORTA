    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit}>
                <h2 className='font-semibold text-lg mb-2'>Isi Data Admin</h2>
                <div className="grid gap-x-6 md:grid-cols-2">
                    ...
                    <div className="mb-6">
                        ...
                        <input type="text" id="jabatan" name="jabatan" onChange={handleChange}
                               className="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red focus:border-red block w-full p-2.5 placeholder-gray-400"
                        />
                    </div>
                    <div className="mb-6">
                        <label htmlFor="jabatan"
                               className="block mb-2 text-sm font-medium text-gray-900 ">Note</label>
                        <input type="text" id="jabatan" name="jabatan" onChange={handleChange}
                               className="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-red focus:border-red block w-full p-2.5 placeholder-gray-400"
                        />
                    </div>
