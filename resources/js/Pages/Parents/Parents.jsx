...
export default function Parents(props) {
    const [filteredItems, setFilteredItems] = useState(props.parents);

    React.useEffect(() => {
        setFilteredItems(props.parents);
    }, [props.parents])
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Wali Anak</h2>}
        >
